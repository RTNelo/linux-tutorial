...
我们之前提到过，在 Linux 中，“万物皆文件”。在 Linux 中，对设备、SOCKET等进行的一系列开关、读写操作归根结底都是在对其对应的文件进行操作。因此文件状态也同样至关重要。回到我们最先提到的概念：在 Linux 系统中，文件的“打开状态”等一系列状态都是通过文件描述符表示的。而**系统是如何描述一个文件的呢？**
